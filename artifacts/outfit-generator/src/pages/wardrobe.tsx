...
const ROWS: { key: RowKey; btnLabel: string; showLabel: boolean; shelfHeading: string | null; headingTopFrac?: number }[] = [
  ...
  { key: "beauty",     btnLabel: "+ ADD BEAUTY",     showLabel: false, shelfHeading: "Tools",    headingTopFrac: 0.448 },
  { key: "essentials", btnLabel: "+ ADD ESSENTIALS", showLabel: false, shelfHeading: "Areas",    headingTopFrac: 0.656 },
];
        ...
        <>
          ...
          {itemsLeft !== null && (
            <button
              ...
              style={{
                position: "absolute",
                top: pY(ir, 0.058), left: "50%", transform: "translateX(-50%)",
                zIndex: 25,
